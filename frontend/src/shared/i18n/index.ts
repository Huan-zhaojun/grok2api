  ...
  "zh-CN": {
    translation: {
      ...
      statusReauthRequired: "失效",
        ...
        deletedWithSkipped: "已删除 {{deleted}} 个账号，跳过 {{skipped}} 个（仍有进行中的视频任务）",
        cleanupCompletedDetailed: "已删除 {{deleted}} 个账号（含关联 {{linked}}），跳过 {{skipped}} 个",
